...
- Built for a resource-constrained environment — no server, no desktop, just a phone

**Stack:** Python · Kotlin · Android · OpenAI API · ffmpeg · Termux
...
**AI / ML**
`HuggingFace Transformers` `PyTorch` `WavLM` `Whisper` `DAPT` `Transfer Learning` `Dataset Curation`

**Languages**
`Python` `JavaScript` `Kotlin` `Java` `C++`
...
- **GitHub:** [spacey-cadet](https://github.com/spacey-cadet)
